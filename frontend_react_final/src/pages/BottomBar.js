...
return(
    <footer className=" navbar-expand-lg navbar-light ">
     <div className="footer sticky-footer footer" id="footer">
       <div className="container">
          ...
          <div className="row">
             ...
             <div className="col-lg-3 offset-mdlg-2     col-md-4 offset-md-1">
                <h3>Contact Us</h3>
                <ul className="conta">
                   <li><i className="fa fa-map-marker" aria-hidden="true"></i> Pune</li>
                   <li> <i className="fa fa-envelope" aria-hidden="true"></i><a href="#"> techinspireacademy@gmail.com</a></li>
       ...
       <div className="copyright">
          <div className="container">
             <div className="row">
                <div className="col-md-10 offset-md-1 text-dark">

                   <p>@techinspireacademy © 2022 All Rights Reserved.</p>
